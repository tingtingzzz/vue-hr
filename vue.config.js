...
module.exports = {
   ...
   * https://foo.github.io/bar/, then publicPath should be set to "/bar/". In
   * most cases please use '/' !!! Detail:
  ...
  chainWebpack(config) {
    // it can improve the speed of the first screen, it is recommended to turn
    // on preload
